...
PanRGC_3_syt1 <- subset(PanRGC_3,subset = percent.mito <30)
PanRGC_3_syt1 <- subset(PanRGC_3_syt1,subset = Syt1 > 0 | Snap25 >0)
...
PanRGC_3_syt1 <- SubsetData(PanRGC_3_syt1,ident.use = c(12,6,8))
...
PanRGC_2 <- subset(PanRGC_2,subset = percent.mito <30)


PanRGC_2_syt1 <- subset(PanRGC_2,subset = Syt1 > 0 | Snap25 >0)
...
PanRGC_2_syt1 <- SubsetData(PanRGC_2_syt1,ident.use = c(14,5,8))
